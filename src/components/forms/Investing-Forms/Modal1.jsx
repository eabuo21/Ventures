    ...
    <>
      <div className="form-container fixed inset-0 z-50 flex items-center justify-center bg-transparent">
        ...
        >
          <button
            onClick={() => onClose()}
            className="absolute top-0 right-0 p-2 py-2 mx-2 bg-white text-red hover:bg-red  hover:text-white transition-all ease-linear hover:transition-all hover:ease-in-out duration-1000 hover:duration-1000 "
          >
            <FontAwesomeIcon
              icon={faTimes}
              times-icon
          ...
          <div className="contents-container w-full h-auto mx-2 p-2 flex flex-col justify-normal bg-gold">
            ...
            <p className=" text-black font-sans font-normal text-sm text-left tracking-wide    md:text-base">
              ...
              <a
                href="src\assets\downloadableassets\Eligibility Criteria, Investment Strategy.pdf"
                target="_blank"
              ...
              &nbsp;
              <a
                href="src\assets\downloadableassets\TONGSTON EXCLUSION LIST.docx.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-700 underline hover:text-red"
              >
                and Tongston’s Exclusion List.
              </a>
              <br />
              <strong>
                <span className="">
