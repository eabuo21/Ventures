        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-3 justify-center items-center">
              ...
              <button
                className={`submit-button bg-red text-white rounded w-[300px] h-[50px] hover:bg-gold hover:text-white hover:transition-all ease-in-out hover:duration-1000 transition-all  duration-1000  ${!checked && "cursor-not-allowed hover:bg-red hover:opacity-50 opacity-50"}`}
                type="submit"
                disabled={!checked}
              >
