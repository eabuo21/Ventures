...
const Sliders = () => {
  ...
  const people = [
    ...
    },
    {
      ...
      quote:
        "I came across TEES2023, thanks to Skills Outside School Foundation. They recommended it for the participants of Skills Outside School Foundation Fellowship. I submitted my proposal and got selected to pitch my innovation. I took home some valuable insights not just from pitching my innovation but from attending the summit itself.",
      // "I would say that one of the biggest lessons for us at Skills on Wheels is consistency in line with your goals. This is because, at a certain point, you will be faced with challenges; but before you started, there was a reason why you got started, and that should keep driving you. Also, be open to learning. You do not know it all. There are entrepreneurs that belong in the space, and they may have some experience that will be useful to you. So, be open to learning and consistently do what you are doing. Also, be impact-oriented. ",
    },
    {
      id: 3,
      image: promise,
